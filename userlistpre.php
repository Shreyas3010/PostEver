...
$con=mysqli_connect("127.0.0.1","root","")or
	...
	/*	
	$result1=mysqli_query($con,"SELECT * FROM posts WHERE 1");
...
<form autocomplete="off" action="searchresult.php" target="target1" method="POST">
  <input type="hidden" value="2" name="whichone">
...
<div><iframe style="border:none;" src="userlist.php" width="100%" height="80%" name="target1"></iframe></div>
</body>
</html>